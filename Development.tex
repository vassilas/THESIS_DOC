...
\ref{appendix:Node_modules} δίνονται όλα τα modules που υλοποιήθηκαν μαζί με τις συναρτήσεις των εξόδων τους. Παρακάτω παρουσιάζεται η HDL περιγραφή των κόμβων του πρώτου επιπέδου όλων των αθροιστών, υπέυθυνα για τον υπολογισμό των σημάτων propagate (p), generate (g) και ημι-αθροίσματος (x).
...
\begin{figure}[H]
    ...
    \caption{Architecture of 8-bit $2^n-1$ Adder}
