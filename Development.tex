...
\centering
     \begin{tabularx}{\textwidth}{ | g | X | } 
        ...
        % 8 - BIT
        % ----------------------------------------------------------------------
        \cellcolor{black} & \cellcolor{LightGray}8-bit \\\hline
        ...
        % 16 - BIT
        % ----------------------------------------------------------------------
        \cellcolor{black} & \cellcolor{LightGray}16-bit \\\hline
        ...
        % 32 - BIT
        % ----------------------------------------------------------------------
        \cellcolor{black} & \cellcolor{LightGray}32-bit \\\hline
        ...
        % 64 - BIT
        % ----------------------------------------------------------------------
        \cellcolor{black} & \cellcolor{LightGray}64-bit \\\hline
        ...
        \cellcolor{black} & \cellcolor{LightGray} \\\hline
